...
#i=17.5
#j=4
for j in 4 1 2 3 4;do 
#for i in 10 7.5 10 12.5 15 17.5 21;do 
for i in 15 7.5 10 12.5 15 17.5 20;do 
    ...
    python rename_pdb_plate.py pore_${i}_silanol_${j}.pdb ${i} --detect-ionized-o --buffer-radius $buffer_size
